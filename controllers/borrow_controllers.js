...
const { request, response } = require("../routes/book_routes")
...
exports.updateBorrowing = async(request, response) => {
    ...
    modelBorrow.update(newData, { where: { id: borrowID } })
        .then(async result => {
...
exports.deleteBorrowing = async(request, response) => {
    ...
    detailsOfBorrowModel.destroy({
        ...
        .then(result => {
            modelBorrow.destroy({ where: { id: borrowID } })
                .then(result => {
                    return response.json({
                        success: true,
...
exports.getBorrow = async(request, response) => {
    let data = await modelBorrow.findAll({
        include: [
            `member`, `admin`,
            {
